...
public class SlashListener extends ListenerAdapter {
    ...
    public void onSlashCommand(SlashCommandEvent event) {
		...
		case "versao":
			...
			break;
		case "invite":
			event.reply("Conecte o ZapBOT ao seu servidor também!").addActionRow(Button.link(String.format("https://discord.com/api/oauth2/authorize?client_id=%s&permissions=2483547216&scope=applications.commands%%20bot", publicKey), "ZapBOT")).queue();
			break;
		case "suporte":
