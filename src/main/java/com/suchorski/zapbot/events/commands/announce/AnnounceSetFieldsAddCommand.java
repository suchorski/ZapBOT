...
import com.suchorski.zapbot.events.listeners.MessageListener;
...
public class AnnounceSetFieldsAddCommand extends BotCommand {
	...
	protected void zapExecute(CommandEvent event) {
		try {
			...
			messageListener.addPass(event.getGuild().getIdLong(), event.getChannel().getIdLong(), event.getAuthor().getIdLong());
