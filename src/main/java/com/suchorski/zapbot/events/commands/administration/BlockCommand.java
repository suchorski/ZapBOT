...
@Component
public class BlockCommand extends BotCommand {
	...
	public void init() {
		this.name = "bloquear";
		this.help = "Bane usuários do BOT na guilda";
		this.aliases = new String[] { "block" };
	...
	protected void zapExecute(CommandEvent event) {
		...
		if (!users.isEmpty()) {
			...
			CommandUtils.success(event, "membros banidos do BOT na guilda");
		} else {
